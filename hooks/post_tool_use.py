...
from parse_tool_result import changed_kinds, changed_paths, command_from_input, detect_failure, verification_coverage, verification_record
        ...
        emit_json(
            {
                "hookSpecificOutput": {
                    ...
                    "additionalContext": "fable-ish: tool failed; verify before final.",
                }
            }
        )
    else:
